...
(async () => {
  try {
    ...
    const tests = [
      ...
      { params: { startDate: '2026-05-01', endDate: '2026-05-05', limit: 5 }, name: 'date range' },
    ];
    for (const test of tests) {
      ...
      console.log(test.name, 'total', res.data.pagination.total, 'returned', res.data.data.length);
    }
  } catch (err) {
