...
export default function CreateShipment() {
  ...
  const [receiverContactSearch, setReceiverContactSearch] = useState<
    Record<string, string>
  >({});
  const isSenderLocked = selectedSenderContactId !== NEW_CONTACT_OPTION;
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <GlobalCountrySelector
                      ...
                      disabled={shippingType === "local" || isSenderLocked}
                ...
                {isSenderLocked && (
                  <p className="text-xs text-slate-500">
                    {isRTL
                      ? "تم اختيار مرسل محفوظ. اختر 'مرسل جديد' من القائمة لتعديل البيانات."
                      : "Saved sender selected. Choose 'New Sender' from the list to edit data."}
                  </p>
                )}
                {/* <div>
              ...
              <div className="space-y-6">
                ...
                {receivers.map((receiver, index) => {
                  ...
                  const isReceiverLocked =
                    receiverSelectedId !== NEW_CONTACT_OPTION;
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <GlobalCountrySelector
                              ...
                              disabled={
                                shippingType === "local" || isReceiverLocked
                              }
                              className="h-11 sm:h-12"
                            />
                          </div>
